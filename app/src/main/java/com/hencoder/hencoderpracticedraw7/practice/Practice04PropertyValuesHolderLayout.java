    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // 第二个： scaleY 从 0 到 1
                // 第三个： alpha 从 0 到 1
                final PropertyValuesHolder scaleX = PropertyValuesHolder.ofFloat("scaleX", 0, 1);
                final PropertyValuesHolder scaleY = PropertyValuesHolder.ofFloat("scaleY", 0, 1);
                final PropertyValuesHolder alpha = PropertyValuesHolder.ofFloat("alpha", 0, 1);
